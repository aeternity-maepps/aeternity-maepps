...
from aevent_api import aevent_api
...
app.config['SECRET_KEY'] = 'aevent-app'
app.config['REMEMBER_COOKIE_NAME'] = 'aevent_app_token'

# uploads folder for aevent images
app.config['UPLOAD_FOLDER'] = upload_folder

# register blueprints to get functionality from aevent and security api's
app.register_blueprint(security_api)
app.register_blueprint(aevents_api)
...
@app.route('/')
def hello():
    return jsonify({'message': 'welcome to the aevent api!'})
